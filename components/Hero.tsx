      ...
      <div className="max-w-6xl mx-auto relative z-20">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-shrink-0">
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden shadow-2xl ring-4 ring-slate-200 animate-float">
              <Image
                src="/avatar.png"
                alt="Ka Reigh Mitchell"
                fill
                className="object-cover"
                priority
                unoptimized
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              Ka Reigh
              <br />
              <span className="gradient-text animate-gradient">Mitchell</span>
            </h1>
            <div
